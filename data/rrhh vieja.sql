...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-03-2025 a las 16:49:01
...
(1, 1, 1, 8, 11, 1, 'Maestria', 1, '04128977094', '0243', '2025-01-20', 'Jubilado', 1, '2025-02-27', '08:42:37 AM'),
...
INSERT INTO `datospersonales` (`id_personal`, `primerNombre`, `segundoNombre`, `primerApellido`, `segundoApellido`, `cedula`, `estadoCivil`, `sexo`, `diaNacimiento`, `mesNacimiento`, `anoNacimiento`, `correo`, `fecha`, `hora`) VALUES
(1, 'Jeison', 'Andres', 'Balduz', 'Gonzalezzz', '30012937', 'Soltero', 'Masculino', '01', '11', '2014', '', '2025-02-27', ' 08:42:37 AM'),
(149, 'Emili', 'Gabriela', 'Torres', 'Girand', '3019704', 'Soltero', 'Masculino', '01', '05', '2003', NULL, '2025-01-16', '00:58:02');
...
(4, 73, 1, 1, 1, 'Departamento', 'Los Samanes', NULL, 'La soledad', 'B1', NULL, '17');
...
--
ALTER TABLE `auditoria`
  MODIFY `id_auditoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=388;
...
--
ALTER TABLE `datosempleados`
  MODIFY `id_empleados` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;

--
-- AUTO_INCREMENT de la tabla `datosfamilia`
--
ALTER TABLE `datosfamilia`
  MODIFY `id_ninos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=173;
...
--
ALTER TABLE `datospersonales`
  MODIFY `id_personal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=172;
...
--
ALTER TABLE `documentacion`
  MODIFY `id_doc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=224;
...
--
ALTER TABLE `notificaciones`
  MODIFY `id_noti` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
