...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
        ...
        <main class=" app-main p-0 pb-4">
            ...
            <div class="container-fluid px-3 z-1 contenedorPrincipal">
                ...
                <div class="d-flex aling-items-center nombre_panel" style="position: absolute; ">
                    <span class="ms-4 fw-bold mt-3 text-white">Registrar familiar</span>
                </div>

                <form action="#" style="font-size: 16px;" class="pt-4 content justify-content-center formulario_empleado contact-form form-validate justify-content-center" novalidate="novalidate" id="formulario_empleado">
    ...
    <script src="<?php echo App::URL_SCRIPTS . "familiares.js" ?>" type="module" defer></script>
</body>
