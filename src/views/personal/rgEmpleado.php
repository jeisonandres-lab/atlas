...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
        ...
        <main class="app-main p-0">
            ...
            <div class="container-fluid contenedorPrincipal">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7 px-0 form-validate " style="text-align: center;">
                        <!-- Titulo de la pagina -->
                        <div class="d-flex aling-items-center nombre_panel" style="position: absolute; ">
                            <span class="ms-4 fw-bold mt-3 text-white">Registrar empleado</span>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xl-5 col-xxl-5 ps-2">
                        <div class="w-100 containerImg col-12 mb-3" style="height: 400px;">
                            <div class="bg-white content d-flex justify-content-center align-items-center h-100 w-100" id="img-contener">
                                <!-- Contenido aquí -->
                            </div>
    ...
    <script src="<?php echo App::URL_SCRIPTS . "registroPersonal.js" ?>" type="module" defer></script>
</body>
