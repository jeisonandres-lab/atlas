...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <script src="<?php echo App::URL_SCRIPTS . "registroTotalFamiliares.js" ?>" type="module"></script>
    <script src="<?php echo App::URL_SCRIPTS . "reporteFamiliar.js" ?>" type="module"></script>
