...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper conten-main" id="conten-main">
        ...
        <main class=" app-main p-0 pb-4">
            <!-- NOMBRE DEL MODULO -->
            <div class="imagen-pages mb-3 h-25"></div>

            <div class="container-fluid px-3 z-1 contenedorPrincipal">

                <div class="d-flex aling-items-center nombre_panel" style="position: absolute; ">
                    <span class="ms-4 fw-bold mt-3 text-white">Registros De Empleado</span>
                </div>

                <div class="row">
                    <div class="col-lg-12">
                        <section class=" content" id="contenTable">
                            <div class=" mitable table-responsive">
                                <div class="d-flex justify-content-start gap-4 mt-5 ms-4">
                                    <button class="custom-export-btn position-relative overflow-hidden" id="mainExportBtn">
                                        <div class="slider-wrapper d-flex flex-column">
                                            <div class="view px-2 text-view d-flex align-items-center justify-content-center">
                                                Exportar
                                            </div>
                                            <div class="view px-3 icons-view d-flex align-items-center justify-content-center">
                                                <i class="fa-solid fa-file-pdf icon-action" data-type="pdf" title="Exportar PDF"></i>
                                                <i class="fa-solid fa-file-excel icon-action" data-type="excel" title="Exportar Excel"></i>
                                                <i class="fa-solid fa-xmark close-trigger icon-action" title="Cancelar"></i>
                                            </div>
                                        </div>
                                    </button>
                                </div>

                                <table id="myTable" class="mitable table table-hover nowrap display">
                                    <thead>
                                        <tr>
    ...
    <script src="<?php echo App::URL_SCRIPTS . "registroFamiliar.js" ?>" type="module" defer></script>
    <script src="<?php echo App::URL_SCRIPTS . "reportesEmpleado.js" ?>" type="module" defer></script>
