...
<head>
    ...
    <link rel="stylesheet" href="<?php echo App::URL_CSS . "Utils/multifrom.css"; ?>">
</head>
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
            ...
            <div class="container-fluid px-3">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-8 col-xxl-8 px-0 mb-2 form-validate " style="text-align: center;">
                        ...
                        <section class="multi-step-form f1">
                            ...
                            <form id="form" class=" ">
                                ...
                                <div class="form-step active">
                                    ...
                                    <div class="btns">
                                        ...
                                        <button type="button" class="btn btn-primary btn-hover-azul mostrar-boton-imagen" id="buttonModalImagen">
                                            ...
                                            Ver Imagen</button>
                                        <button type="button" class="next btn btn-next btn-warning text-white btn-hover-amarillo"><i class="fa-solid fa-arrow-right me-2"></i>Siguiente</button>
                                ...
                                <div class="form-step">
                                    ...
                                    <!-- Botones -->
                                    <div class="btns">
                                        <button type="button" class="prev btn btn-secondary btn-hover-gris"><i class="fa-solid fa-arrow-left me-2"></i>Atrás</button>
                                        <button type="button" class="next btn btn-warning text-white btn-hover-amarillo"><i class="fa-solid fa-arrow-right me-2"></i>Siguiente</button>
                                    </div>
                                </div>
                    ...
                    <div class="container col-sm-12 col-md-5 col-lg-5 col-xl-4 col-xxl-4 pe-0">
                        <div class="w-100 containerImg col-12 mb-3" style="height: 400px;">
                            <div class="multi-step-form bg-white d-flex justify-content-center align-items-center h-100 w-100" id="img-contener">
                                <!-- Contenido aquí -->
                            </div>
    ...
    <script src="<?php echo App::URL_SCRIPS . "utils/multifrom2.js" ?>" type="module" defer></script>
