...
class VacacionesModel extends EjecutarSQL {

    protected function registrarAusencia($tabla, $datos){
    ...
    protected function estadoAusencia(array $parametros){
    ...
    protected function datosAusencia(array $parametros){
        $sql = $this->ejecutarConsulta("SELECT *
        FROM ausenciajustificada au
        INNER JOIN datosempleados dp ON au.idEmpleado = dp.id_empleados
        INNER JOIN datospersonales dpe ON dp.idPersonal = dpe.id_personal
    ...
    protected function totaldatosAusencia(){
