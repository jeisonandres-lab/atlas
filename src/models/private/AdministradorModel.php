...
class AdministradorModel extends EjecutarSQL
{
    ...
    protected function existeUsuario(array $parametros, string $validacion)
    {
    ...
    protected function preguntasSeguridad(array $parametros)
    {
