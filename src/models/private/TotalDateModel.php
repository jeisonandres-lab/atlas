...
class TotalDateModel extends EjecutarSQL
{
    protected function totalDatospersonal()
    {
    ...
    protected function totalMedicamentos()
    {
        $sql = $this->ejecutarConsulta(
    ...
    protected function atencionMedica($parametro)
    {
        $sql = $this->ejecutarConsulta(
