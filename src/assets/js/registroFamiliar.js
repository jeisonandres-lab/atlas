...
import { ExportButton } from './class/botonExport.js';
...
$(function () {
  ...
  // Para el caso por defecto
    ...
    // Para personalizar (ejemplo con IDs o clases diferentes)
    const customExportBtn = new ExportButton({
        mainBtn: '#mainExportBtn',  // ID o clase del botón principal
        closeBtn: '.close-trigger',         // Clase o ID del botón de cerrar
        actionIcons: '.icon-action'      // Clase de los iconos
    });
  ...
  let table = new DataTable('#myTable', {
    ...
    layout: {
      topStart: {
        pageLength: {
          menu: [
            [8, 10, 15, 30, -1], // Valores
            ['8','10', '15', '30', 'Todos'] // Etiquetas
          ],
        },
