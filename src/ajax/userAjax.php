...
$nombreUsuario = isset($_POST['nombreUsuario']) ? $conexion->limpiarCadena($_POST['nombreUsuario']) : "";
...
switch ($_GET['modulo_usuario']) {
    ...
    case 'desactivarUsuario':
        $usercontroller->desactivarUsuario($id, $nombreUsuario);
        break;

         case 'activarUsuario':
        $usercontroller->activarUsuario($id, $nombreUsuario);
        break;
