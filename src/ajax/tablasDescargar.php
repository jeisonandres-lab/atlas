...
// $cargo = isset($_POST['cargo']) ? $conexion->limpiarCadena($_POST['cargo']) : "";
// $edad = isset($_POST['edad']) ? $conexion->limpiarCadena($_POST['edad']) : "";
// $estatus = isset($_POST['estatus']) ? $conexion->limpiarCadena($_POST['estatus']) : "";
// $estadoCivil = isset($_POST['civil']) ? $conexion->limpiarCadena($_POST['civil']) : "";
...
// $estado = isset($_POST['estado']) ? $conexion->limpiarCadena($_POST['estado']) : "";
// $municipio = isset($_POST['municipio']) ? $conexion->limpiarCadena($_POST['municipio']) : "";
// $parroquia = isset($_POST['parroquia']) ? $conexion->limpiarCadena($_POST['parroquia']) : "";

// $fechaing = isset($_POST['fechaing2']) ? $conexion->limpiarCadena($_POST['fechaing2']) : "";
// $fecha_ini = isset($_POST['fecha_ini2']) ? $conexion->limpiarCadena($_POST['fecha_ini2']) : "";
// $fecha_fin = isset($_POST['fecha_fin2']) ? $conexion->limpiarCadena($_POST['fecha_fin2']) : "";

// $dependencia = isset($_POST['dependencia']) ? $conexion->limpiarCadena($_POST['dependencia']) : "";
// $departamento = isset($_POST['departamento']) ? $conexion->limpiarCadena($_POST['departamento']) : "";
...
switch ($_GET['accion']) {
    ...
    case 'impirimirPersonalizado':
        ...
        $fecha_ini_convertida = convertirFecha($fecha_ini);
        $fecha_fin_convertida = convertirFecha($fecha_fin);
        $reportes->generarPDFPersonalizado(
            $idCargo,
            $sexo,
            $edad,
            $civil,
            ...
            $idMunicipio,
            $idParroquia,
            $fecha_ini_convertida,
            $fecha_fin_convertida,
            $fecha_ini,
            $fecha_fin
        );
        break;
    ...
    case 'impirimirEmpleadosCargoExcel':
        $excelgenerator->generarExcelCargo($idCargo);
        break;
    ...
    case 'impirimirEmpleadosDireccionExcel':
        $excelgenerator->generarExceldireccion($idestado, $idMunicipio, $idParroquia);
        break;
    ...
    case 'impirimirEmpleadosDependenciaExcel':
        $excelgenerator->generarExceldependencia($idDependencia);
        break;
    case 'impirimirEmpleadosDepartamentoExcel':
        $excelgenerator->generarExceldepartamento($idDepartamento);
        break;
    case 'impirimirPersonalizadoExcel':
        function convertirFecha($fecha)
        {
            // Crea un objeto DateTime a partir de la fecha en formato dd-mm-aaaa
            $fechaObj = DateTime::createFromFormat('d-m-Y', $fecha);
        ...
        $fecha_ini_convertida = convertirFecha($fecha_ini);
        $fecha_fin_convertida = convertirFecha($fecha_fin);
        $excelgenerator->generarExcelPersonalizado(
            $idCargo,
            $sexo,
            $edad,
            $civil,
